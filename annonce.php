...
<html>
<head>
	<title>Visiter nos annonce</title>
	<head>
		<meta charset="utf-8">
...
if($_GET['page']==1)
$sql="SELECT * FROM `annonce` WHERE prix<".$_POST['prix']." and superficie>".$_POST['superficie']." and type='".$_POST['type']."' and quatier='".$_POST['quatier']."' 'achat/location'='".$_POST['choix']."' ";
...
<table border="2">
	<tr>
		<td rowspan="3" width=><img src="Image/font.jpeg" heigt=150 width=150></td>
		<td>
			<table border="2">
